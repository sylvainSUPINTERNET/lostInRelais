...
import { generatePKCE } from "../../utils/oauth2/pkce";
      ...
      try {
        ...
        const authUrl = `https://accounts.google.com/o/oauth2/v2/auth/oauthchooseaccount?` +
          `scope=${encodeURIComponent(
            "https://www.googleapis.com/auth/youtube.readonly https://www.googleapis.com/auth/youtube.upload https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile"
          )}` +
        ...
        console.error("OAuth2 Google", error);
